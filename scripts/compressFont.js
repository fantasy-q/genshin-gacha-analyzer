...
const searchPattern = 'src/**/*.@(js|vue)' //搜索文件 glob语法
const outputDir = 'src/assets/fonts' // 输出文件位置

const fontData = [
  {
    fontLoc: 'src/assets/HYWenHei-65W.ttf',
    fontFamily: 'HYWenHei',
    fontWeight: 'normal'
  },
  {
    fontLoc: 'src/assets/HYWenHei-85W.ttf',
    fontFamily: 'HYWenHei',
    fontWeight: 'bold'
  }
]
...
glob(searchPattern, function (er, files) {
  ...
  Promise.all(
    fontData.map(({ fontLoc, fontFamily, fontWeight }) => {
